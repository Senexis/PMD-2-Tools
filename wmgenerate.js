...
WMSGen = {
	...
	"setup": function (form) {
		...
		if (this.advanced) {
			...
			document.getElementById('advancedModeOnlyStuff').style.display = 'block';
		}
	...
	"fillSubTypeList": function () {
		...
		if (typeData && typeData.subTypes) {
			...
			document.getElementById('subType').style.display = "inline";
		}
		else {
	...
	"update": function () {
		...
		document.getElementById('target2').style.display = (typeData.useTarget2 ? 'block' : 'none');
